...
/*N*/
/*N*/ 	//Transformation berechnen, die sp�ter im Paint ausgef�hrt wird,
...
/*N*/ 		//alle in der Liste sind gleicherma�en gedreht
...
/*N*/ 		if(nAngle!=0)
/*N*/ 		{
/*?*/ 			//Um TopLeft drehen, so wie es sp�ter gezeichnet wird
/*?*/ 			XPolygon aPoly(aPrevRect);
/*?*/ 			aPoly.Rotate(aPrevRect.TopLeft(),(USHORT)nAngle);
/*?*/ 			//und um den Koordinaten-Ursprung herum zur�ckdrehen
/*?*/ 			//um wieder Rectangles zu erhalten (f�r Intersect)
...
/*N*/ 		while(p3DObj)
/*N*/ 		{
/*N*/ 			//n�chstes Objekt holen, abh�ngig davon, ob das zuletzt behandelte
...
/*N*/ 			//als auch GetCurObject() den alten Pointer zur�ckgeben,
/*N*/ 			//wird getestet, ob tats�chlich verschiedene Objekte vorliegen
...
/*?*/ 					//und um den Ursprung herum zur�ckdrehen
/*?*/ 					aPoly.Rotate(Point(0,0),(USHORT)(3600 - nAngle));
...
/*N*/ 						 ||(aIntersect.GetWidth() >aNextRect.GetHeight()/100)//2% Deckung maximal bezogen auf die Fonth�he
/*N*/ 						)
/*N*/ 				  )
/*N*/ 				{
