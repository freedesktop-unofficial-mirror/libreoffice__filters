...
/*N*/
/*N*/ 	Matrix4D aShift;
/*N*/ 	aShift.Translate(-(aSizeVec/500.0));//W�nde etwas verschieben...
/*N*/
...
/*N*/ 						E3dLabelObj *pE3DLabel = new E3dLabelObj(aTextPos,pTextObj);
/*N*/ 						pE3DLabel->SetMarkProtect(TRUE);
/*N*/ 						aZDescrList.insert( aZDescrList.begin(), pE3DLabel );//ZListe umgekehrt f�llen
/*N*/ 					}
/*N*/
/*N*/ 					if (pZGridHelpGroup && (i < nRowCnt))
/*N*/ 					{
...
/*?*/ 								{
/*?*/ 									//aFrontSide wird noch f�r die Beschriftung gebraucht
...
/*N*/
/*N*/ 	//erweiterung auf Donuts  em�glichen!
/*N*/ 	long nColCnt = GetColCount();
