...
/*N*/ 	pChartAAxis->SetPosition(CHAXIS_POS_B); //A,B sind sekund�re Achsen => oben und rechts
/*N*/ 	pChartBAxis->SetPosition(CHAXIS_POS_B);
/*N*/ 	pChartXAxis->SetPosition(CHAXIS_POS_A); //prim�re Positionen=links, unten
...
/*N*/
/*N*/ 	Create2DXYTitles(rRect,bSwitchColRow);	//abziehen der Achsen-Titel-Fl�che
/*N*/
...
/*N*/
/*N*/ 	//Zusammenfassen ???
/*N*/ 	pChartYAxis->CalcMaxTextSize();//#63904# 14%, aber Aufruf nur wenn n�tig
...
/*N*/
/*N*/ 	pChartXAxis->SetArea(rRect); //Die X-Achsenl�nge ist bereits bekannt! wichtig f�r nDescrWidth
/*N*/ 	pChartAAxis->SetArea(rRect); //Die Y-L�ngen werden nachfolgend korrigiert
/*N*/
/*N*/ 	pChartAAxis->SetColTextMode(!IsXYChart(),!bPartDescr);
/*N*/ 	pChartXAxis->SetColTextMode(!IsXYChart(),!bPartDescr);
/*N*/
/*N*/ 	//f�r die X-Achse gibt es ein paar sonderregel, insbesondere wird
/*N*/ 	//das Rect auch in der X-Breite ge�ndert, wenn die Spaltenunterschriften sehr lang sind
/*N*/ 	//hinzu kommt noch Umbruch (an Y-Achse nicht vorgesehen), daher mu?hier eine
/*N*/ 	//Sonderbehandlung erfolgen, auch das InitDescr erfolgt hier nachtr�glich!
...
/*N*/
/*N*/ 	pChartXAxis->SetArea(rRect); //jetzt sind x und y l�nge bekannt
...
/*N*/
/*N*/ 	if(IsXYChart())
/*N*/ 	{	//Achtung! Die X-Achse unterst�tzt Umbruch (nColumnTextWidth)!
/*N*/ 		pChartXAxis->InitDescr();
/*N*/ 		pChartAAxis->InitDescr();
/*N*/ 	}
/*N*/ 	else //Hier wird der ColText genutzt -> Beschr�nkung auf maMaxTextSize!
/*N*/ 	{
...
/*N*/ 		nR1=nR2=1;
/*N*/ 	}
/*N*/ 	else //sonst Datenreihen mit Balken je Achse z�hlen: (Lines fallen weg)
/*N*/ 	{
...
/*N*/ 	}
/*N*/
/*N*/ 	if(!nR1)    //Verbundcharts, Lines werden oben nicht ber�cksichtigt,
...
/*N*/
/*N*/ 			//Achse und Bardescriptor w�hlen, Insertreihenfolge festlegen  ->
...
/*N*/ 						if (bIsLine)//#50212#
/*N*/ 						{
/*?*/ 							pLine[nRow-nLineStart][1] = Point(pBar->Middle()//MIDPOS//zu umst�ndlich: nPos + nPartWidth/2 - nGap
...
/*N*/ 					if(nRow==nStart)//geht auch sch�ner: bInitialise (ToDo:)
/*N*/ 					{
...
/*?*/ 				//fehlende Werte werden hier als 0 interpretiert - weglassen des BlockInhalts w�re Interpolation!
