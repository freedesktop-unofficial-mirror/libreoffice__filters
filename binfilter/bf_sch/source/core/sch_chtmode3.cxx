...
/*N*/
/*N*/ 	if(!bInsert)
/*N*/ 		n1Pixel=nHalfSymbolSizeY/2; //f�r Legende vergr��ern
/*N*/
...
/*N*/ 				}
/*N*/ 				nWhatSymbol=nRow;
/*N*/ 				aDataAttr.ClearItem(SCHATTR_SYMBOL_BRUSH);//Gr��e gegebenenfalls l�schen
/*N*/ 				aDataAttr.ClearItem(SCHATTR_SYMBOL_SIZE);//Gr��e gegebenenfalls l�schen
/*N*/ 				break;
/*N*/
...
/*N*/ {
/*N*/ 	// Symbole immer gleiche Umrandung und F�llfarbe = Linienfarbe, wenn es sich um ein "echtes"
/*N*/ 	// Symbol handelt (d.h. nicht ein Symbol f�r Bars/S�ulen,Pies etc.)
/*N*/
/*N*/ 	switch(nMode)
/*N*/ 	{
...
/*N*/ }
/*N*/
/*N*/ //Achtung! diese Funktion sollte nur f�r 3-D-Objekte ausgef�hrt werden,
/*N*/ //bei z.B. Legendensymbolen f�hrt der Aufruf zu einer Endlos-Schleife !!!!!!!!!!!!!
...
/*N*/
/*N*/ 	//Eventuell 3D-Materialfarbe in 2D-F�llfarbe konvertieren:
...
/*N*/ {
/*N*/ 	//ToDo: Das hier k�nnte man auch sch�ner machen (kein DEEP!)
...
//(ungef�hrlich, geringer Overhead, wirft daher nur DBG__TRACE)
//Nicht-Singul�re Objekte k�nnen nicht an der ID alleine identifiziert werden,
//in diesem Fall muss GetAttr(SdrObject*) statt GetAttr(long id) gerufen werden
// GetAttr(long id, SfxItemSet&) besorgt alle f�r ein Objekt verf�gbaren und
// g�ltigen Attribute
...
/*N*/
/*N*/ 		case CHOBJID_LEGEND_BACK: //Achtung, dies ist nur das Drawing-Objekt, normalerweise erh�lt man die andere ID f�r das Gruppenobjekt
/*N*/ 		case CHOBJID_LEGEND:
